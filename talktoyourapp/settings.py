"""
Django settings for talktoyourapp project.
...
ROOT_URLCONF = 'talktoyourapp.urls'

WSGI_APPLICATION = 'talktoyourapp.wsgi.application'
...
TWILIO_CALLING_NUMBER = os.getenv('TWILIO_CALLING_NUMBER')
